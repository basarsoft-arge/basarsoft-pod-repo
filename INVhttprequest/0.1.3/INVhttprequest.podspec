...
Pod::Spec.new do |s|
  ...
  s.source_files = "INVhttprequest.xcframework/**/*.{h,hpp,m,swift}"
  s.public_header_files = "INVhttprequest.xcframework/**/*.{h,hpp}"
  s.preserve_paths = "INVhttprequest.xcframework"
