...
Pod::Spec.new do |s|
  ...
  s.source_files = "INVPackageManager.xcframework/**/*.{h,hpp,m,swift}"
  s.public_header_files = "INVPackageManager.xcframework/**/*.{h,hpp}"
  s.preserve_paths = "INVPackageManager.xcframework"
