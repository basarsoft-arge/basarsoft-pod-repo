...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/inavi/INVNotificationService/0.2.3/INVNotificationService.xcframework.zip"}
