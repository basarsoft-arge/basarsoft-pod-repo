Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/yolbil/YolbilFramework/132.2.3/YolbilFramework.framework.zip'}
