Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/yolbil/YolbilFramework/134.0.0/YolbilFramework.framework.zip'}
