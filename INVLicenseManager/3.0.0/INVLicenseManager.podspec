...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/inavi/INVLicenseManager/3.0.0/INVLicenseManager.xcframework.zip"}
