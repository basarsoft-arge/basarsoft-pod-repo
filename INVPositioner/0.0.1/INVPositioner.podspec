...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/inavi/INVPositioner/0.0.1/INVPositioner.xcframework.zip"}

  s.vendored_frameworks = 'INVPositioner.xcframework'

  s.cocoapods_version = ">= 1.10.1"

  s.dependency "INVSensorManager", '~> 0.0.1'
