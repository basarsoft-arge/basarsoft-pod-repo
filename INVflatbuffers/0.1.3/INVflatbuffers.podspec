...
Pod::Spec.new do |s|
  ...
  s.source_files = "INVflatbuffers.xcframework/**/*.{h,hpp,m,swift}"
  s.public_header_files = "INVflatbuffers.xcframework/**/*.{h,hpp}"
  s.preserve_paths = "INVflatbuffers.xcframework"
