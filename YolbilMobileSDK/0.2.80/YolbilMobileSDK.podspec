...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/yolbil/YolbilMobileSDK/0.2.80/YolbilMobileSDK.xcframework.zip"}
  ...
  s.dependency "INVPackageManager", "~> 0.2"
  s.dependency "INVSensorManager", "~> 0.2"
  s.dependency "INVHelper", "~> 0.2"
