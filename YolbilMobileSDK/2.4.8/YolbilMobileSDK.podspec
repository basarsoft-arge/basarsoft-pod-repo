...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/yolbil/YolbilMobileSDK/2.4.8/YolbilMobileSDK.xcframework.zip"}
  ...
  s.dependency "INVSensorManager", "~> 4.0"
