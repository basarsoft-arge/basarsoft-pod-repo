...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://repo.inavi.us/artifactory/generic-dev-local/pods/inavi/SensorManager/0.1.2-rc.3/SensorManagerAPI.framework.zip"}
